...
?>
	...
	switch ($_GET['act']) {
		...
		case "tambahpengetahuan":
			echo "	<div class='alert alert-success alert-dismissible'>
                ...
                Silahkan pilih efek samping obat yang sesuai dengan obat yang ada, dan berikan <b>nilai kepastian (MB & MB)</b> dengan cakupan sebagai berikut:<br><br>
				<b>1.0</b> (Sangat yakin)&nbsp;&nbsp;|&nbsp;&nbsp;<b>0.8</b> (Yakin)&nbsp;&nbsp;|<br>
				<b>0.6</b> (Cukup yakin)&nbsp;&nbsp;|&nbsp;&nbsp;<b>0.4</b> (Kurang yakin)&nbsp;&nbsp;|<br>
				...
				<b>Contoh:</b><br>
				Jika kepercayaan <b>(MB)</b> anda terhadap efek samping obat <b>Jatung berdebar</b> untuk jenis obat <b>Antimo</b> adalah <b>0.8 (Yakin)</b><br>
				Dan ketidakpercayaan <b>(MD)</b> anda terhadap efek samping obat <b>Jatung berdebar</b> untuk jenis obat <b>Antimo</b> adalah <b>0.2 (Tidak tahu)</b><br><br>
				<b>Maka:</b> CF(Pakar) = MB – MD (0.8 - 0.2) = <b>0.6</b> <br>
				Dimana nilai kepastian anda terhadap efek samping obat <b>Jatung berdebar</b> untuk jenis obat <b>Antimo</b> adalah <b>0.6 (Kemungkinan Besar)</b>
              </div>
          <form name=text_form method=POST action='$aksi?module=pengetahuan&act=input' onsubmit='return Blank_TextField_Validator()'>
          <br><br><table class='table table-bordered'>
		  <tr><td width=120>Jenis Obat</td><td><select class='form-control' name='kode_penyakit'  id='kode_penyakit'><option value=''>- Pilih jenis obat -</option>";
			...
			echo	"</select></td></tr>
		<tr><td>Efek Samping</td><td><select class='form-control' name='kode_gejala' id='kode_gejala'><option value=''>- Pilih efek samping obat -</option>";
	...
	<form name=text_form method=POST action='$aksi?module=pengetahuan&act=update' onsubmit='return Blank_TextField_Validator()'>
          ...
          <br><br><table class='table table-bordered'>
		  <tr><td width=120>Jenis Obat</td><td><select class='form-control' name='kode_penyakit' id='kode_penyakit'>";
			$hasil4 = mysqli_query($conn, "SELECT * FROM penyakit order by nama_penyakit");
			while ($r4 = mysqli_fetch_array($hasil4)) {
			...
			echo	"</select></td></tr>
		<tr><td>Efek samping obat</td><td><select class='form-control' name='kode_gejala' id='kode_gejala'>";
			$hasil4 = mysqli_query($conn, "SELECT * FROM gejala order by nama_gejala");
			while ($r4 = mysqli_fetch_array($hasil4)) {
