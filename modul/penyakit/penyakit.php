  ...
  switch ($_GET['act']) {
      ...
      if ($_POST['Go']) {
        ...
        if ($numrows > 0) {
          echo "<div class='alert alert-success alert-dismissible'>
                ...
                Obat yang anda cari di temukan.
              </div>";
          $i = 1;
          ...
          echo "<div class='alert alert-danger alert-dismissible'>
                ...
                Maaf, Obat yang anda cari tidak ditemukan , silahkan inputkan dengan benar dan cari kembali.
              </div>";
        }
      } else {
    ...
    case "tambahpenyakit":
      echo "<form name=text_form method=POST action='$aksi?module=penyakit&act=input' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
          <br><br><table class='table table-bordered'>
		  <tr><td width=120>Nama Obat</td><td><input autocomplete='off' type=text placeholder='Masukkan Obat baru...' class='form-control' name='nama_penyakit' size=30></td></tr>
		  <tr><td width=120>Detail Obat</td><td> <textarea rows='4' cols='50' class='form-control' name='det_penyakit'type=text placeholder='Masukkan detail obat baru...'></textarea></td></tr>
    ...
    case "editpenyakit":
      ...
      echo "<form name=text_form method=POST action='$aksi?module=penyakit&act=update' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
          ...
          <br><br><table class='table table-bordered'>
		  <tr><td width=120>Nama Obat</td><td><input autocomplete='off' type=text class='form-control' name='nama_penyakit' size=30 value=\"$r[nama_penyakit]\"></td></tr>
		  <tr><td width=120>Detail Obat</td><td><textarea rows='4' cols='50' type=text class='form-control' name='det_penyakit'>$r[det_penyakit]</textarea></td></tr>
