...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="aset/banner/2.png" alt="First slide">
      <div class="carousel-caption">
      </div>
    </div>
    <div class="item">
      <img src="aset/banner/banner1.jpeg" alt="Second slide">
      <div class="carousel-caption">
      </div>
    </div>
  </div>
...
<div class="row">
  <div class="col-sm-4 text-center padding wow fadeIn animated" data-wow-duration="1000ms" data-wow-delay="300ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 300ms; animation-name: fadeIn;">
    <div class="single-service">
      ...
      <img src="aset/banner/" alt="">

      <h2 class="text-left">Aplikasi Responsif</h2>
      <p class="text-left">Sistem pakar adalah suatu program komputer yang dirancang untuk memodelkan kemampuan penyelesaian masalah yang dilakukan seorang pakar</p>
    </div>
  </div>
  <div class="col-sm-4 text-center padding wow fadeIn animated" data-wow-duration="1000ms" data-wow-delay="600ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 600ms; animation-name: fadeIn;">
    <div class="single-service">
      ...
      <h2 class="text-left">Medikal</h2>
      <p class="text-left">Efek samping obat menurut WHO adalah tiap respon terhadap obat yang merugikan atau tidak diharapkan,
        yang terjadi pada dosis obat yang digunakan pada manusia untuk tujuan pencegahan, diagnosis dan terapi.
      </p>
    </div>
  </div>
  <div class="col-sm-4 text-center padding wow fadeIn animated" data-wow-duration="1000ms" data-wow-delay="900ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 900ms; animation-name: fadeIn;">
    <div class="single-service">
      <img src="aset/banner/ic" alt="">
      <h2 class="text-left">Admin Pakar</h2>
      <p class="text-left">Terdapat fitur admin pakar, untuk mengatur pengetahuan dan nilai CF pakar, telah di sesuaikan tampilannya sehingga pakar bisa lebih mengeksplore aplikasi.</p>
    </div>
  </div>
</div>
<div></div>