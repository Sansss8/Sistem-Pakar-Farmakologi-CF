...
<head>
  ...
  <base href="http://localhost/spakar/">
  <link rel="icon" href="aset/tentang/logoSttb.png">
...
<body id="pakarayam" class="hold-transition skin-blue-light sidebar-mini">
  <div class="wrapper">
    <!-- Main Header -->
            ...
            ?>
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="gambar/admin/1.png" class="user-image" alt="User Image"> <?php echo ucfirst($_SESSION['username']); ?>
                  <span class="hidden-xs"><?php echo $user; ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="gambar/admin/1.png" class="img-circle" alt="User Image">
                    <p>
    ...
    <footer class="main-footer">
      ...
      <strong>
        <div class="cinta">Sistem Pakar Kelompok 2 </i> by STTB</div>
      </strong>
    </footer>
