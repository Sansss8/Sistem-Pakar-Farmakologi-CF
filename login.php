...
if ($ketemu>0) {
  ...
  echo " <link href='css/font-awesome-4.2.0/font-awesome-4.2.0/css/font-awesome.min.css' rel='stylesheet'>
		...
		<div class='errorpage'> <center><div class='danger'><i class='fa fa-exclamation-triangle'></i></div><br><h1>Teutiasa Lebet!</h1>
       Hapunteun Username sinareng Password na lepat.<br><br><input name='submit' id='submitku' type=submit style='padding: 6px 12px;' value='ULANGI LAGI' onclick=location.href='formlogin'></a><br><br><a href='formlogin'>Halaman login</a></p></center></div>
...
<div class='chick-wrapper-run run'><img class='egg-lay' src='animasi/login/1.png'/>
  <div class='legs'>
    <div class='leg-l'></div>
    <div class='leg-r'></div>
  </div>
